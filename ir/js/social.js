$(function() {
    ...
    function sectionShow() {
        ...
        point1 = whatsShow.offset().top;

        $(window).bind('load scroll resize', function() {
            var bottomLine = $(this).scrollTop() / 1.1;

            if (point1 / 1.8 <= bottomLine) {
                hideNav.css({ transform: 'translateY(0%)' });
            } else if (0 == bottomLine) {
                hideNav.css({ transform: 'translateY(100%)' });
            }
        });
