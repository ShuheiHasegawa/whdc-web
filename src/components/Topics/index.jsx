            ...
            >
              <div className={styles.newsContent}>
                ...
                <div className={styles.newsCategory}>
                  {newsItems.pressRelease.category}
                </div>
                <div className={styles.newsDate}>
                  {newsItems.pressRelease.date}
                </div>
                <a
                  href={newsItems.pressRelease.url}
          ...
          <div className="col-lg-6 pt-2 pb-2">
            ...
            >
              <div className={styles.newsContent}>
                ...
                <div className={styles.newsCategory}>
                  {newsItems.disclosure.category}
                </div>
                <div className={styles.newsDate}>
                  {newsItems.disclosure.date}
                </div>
                <a
                  href={newsItems.disclosure.url}
                  className={styles.newsTitle}
                  target="_blank"
                  rel="noopener noreferrer"
                >
