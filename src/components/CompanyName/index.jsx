        ...
        <div className="row justify-content-center">
          <div className="col-12">
            ...
            <div className="p-4">
              ...
              <p className="mb-4">
                ■5大要素<br />
                ・1つ目のWHY理念は顧客、社員、社会価値の創造、提供です。<br />
                ・2つ目のHOW戦略は働き方、稼ぎ方、儲け方の仕組みづくりです。<br />
                ・3つ目のDO実行は計画、実行、レビュー、カイゼンのサイクルです。<br />
                ・4つ目のKPI重要業績評価指標は営業利益、ROS、キャッシュフローの拡大です。<br />
                ・5つ目のKGI重要統治評価指導は持続的成長の確保、中長期的な企業価値の向上、社会貢献です。<br />
